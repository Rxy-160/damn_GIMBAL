...
/// @param type 类型 0:虚拟串口 1:USART1
/// @return 
int ControltoVision(union RUI_U_VISION_SEND*  Send_t , uint8_t *buff, uint8_t type,User_Data_T *users,VT13_Typedef *VT13_DBUS,IMU_Data_t *IMU_Data,TYPEDEF_VISION *VISION_V_DATA,MOTOR_Typdef *ALL_MOTOR)
{
    uint8_t status;
   VisionSendInit(Send_t,VISION_V_DATA,users,VT13_DBUS,IMU_Data,ALL_MOTOR);
    buff[0] = 0xcd;
	//pitch
