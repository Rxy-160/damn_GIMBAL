...
void VT13_Resovled(uint8_t* Data, VT13_Typedef* VT13,VT13_UNION_Typdef *VT13_UNION)
{
	...
	{
		VT13->RUI_V_VT13_ONLINE_JUDGE_TIME  = RUI_DF_DBUS_OFFLINE_TIME;
//    DBUS_UNION_Typdef RUI_V_DBUS_UNION = { 0 };
		...
		VT13->Remote.Channel[2] = VT13_UNION->DataNeaten.ch_3 - 1024;
		VT13->Remote.Channel[3] = VT13_UNION->DataNeaten.ch_2 - 1024;
		
		VT13->Remote.wheel = VT13_UNION->DataNeaten.wheel - 1024;
		
		VT13->Remote.mode_sw = VT13_UNION->DataNeaten.mode_sw;   ///中间左-右 0 1 2
		//////0 普通打开摩擦轮模式
		//////1 普通关闭摩擦轮模式
		//////2 视觉模式
		...
		VT13->Remote.pause = VT13_UNION->DataNeaten.pause;////暂停键
		VT13->Remote.fn_1 = VT13_UNION->DataNeaten.fn_1;//左上
		VT13->Remote.fn_2 = VT13_UNION->DataNeaten.fn_2;//右上
		VT13->Remote.trigger = VT13_UNION->DataNeaten.trigger;//照相键
