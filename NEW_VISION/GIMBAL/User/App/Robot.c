...
//											{
												CONTAL->HEAD.Pitch =/*-7.1*22.755555555555 ; *//*pitch_TD;*/ (-Vision->RECEIVE  .PIT_DATA   *22.75555555555556f)+Vision->RECEIVE .Pitch_plan* 0.001f*8192.0f/360.0f; 
...
//											{
												CONTAL->HEAD .Yaw   = /*yaw_TD; *//*-0.08*22.75555555555555;*/ (-Vision->RECEIVE .YAW_DATA *22.75555555555556f)+Vision->RECEIVE .Yaw_plan * 0.001f*8192.0f/360.0f;
//											}
