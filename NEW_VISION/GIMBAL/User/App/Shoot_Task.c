...
//        }
    ...
    {
			MOTOR->DJI_3508_Shoot_M.DATA.Aim =(float )MOTOR->DJI_3508_Shoot_M .DATA .Angle_Infinite-/*36864*/8000;//18hz    10800
...
//    ATTACK_V_PARAM.SPEED = MATH_D_LIMIT(6370.0f, 6180.0f, ATTACK_V_PARAM.SPEED);
    ...
    {
        MOTOR->DJI_3508_Shoot_L .DATA .Aim =  -(ATTACK_V_PARAM.SPEED+20);
