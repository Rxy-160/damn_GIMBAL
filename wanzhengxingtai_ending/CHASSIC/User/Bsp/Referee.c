...
void Read_Data_first(ALL_RX_Data_T *ALL_RX_Data , User_Data_T *usr_data , uint16_t length)
{
	...
	for(i = 0; i<length ; i++)
	{
		...
		{
						memcpy(&ALL_RX_Data_Tmp.Data[0] , &ALL_RX_Data->Data[i] , 255);
...
//                    user_data->game_robot_HP.        = ALL_RX_Data->RX_Data_game_robot_HP.game_robot_HP.red_base_HP;
...
//					user_data->power_heat_data.chassis_power_reserved       = ALL_RX_Data->RX_Data_power_heat_data.power_heat_data.chassis_power_reserved;
                    ...
                    user_data->power_heat_data.shooter_17mm_barrel_heat   = ALL_RX_Data->RX_Data_power_heat_data.power_heat_data.shooter_17mm_barrel_heat;
...
//                    user_data->ground_robot_position.standard_5_y   = ALL_RX_Data->RX_Data_ground_robot_position.ground_robot_position.standard_5_y;
            ...
            case Radar_Marking:
            {
                ...
                {
					user_data->radar_mark_data.opp_hero_marked        = ALL_RX_Data->RX_Data_radar_mark_data.radar_mark_data.opp_hero_marked ;
                    user_data->radar_mark_data.opp_engineer_marked    = ALL_RX_Data->RX_Data_radar_mark_data.radar_mark_data.opp_engineer_marked ;     
                    user_data->radar_mark_data.opp_infantry_3_marked  = ALL_RX_Data->RX_Data_radar_mark_data.radar_mark_data.opp_infantry_3_marked ;
                    user_data->radar_mark_data.opp_infantry_4_marked  = ALL_RX_Data->RX_Data_radar_mark_data.radar_mark_data.opp_infantry_4_marked ;
//                    user_data->radar_mark_data.mark_standard_5_progress = ALL_RX_Data->RX_Data_radar_mark_data.radar_mark_data.mark_standard_5_progress;
					user_data->radar_mark_data.opp_sentry_marked      = ALL_RX_Data->RX_Data_radar_mark_data.radar_mark_data.opp_sentry_marked  ;
                }
            }break;
            ...
            case Route_Informat:
            {
                ...
                {
                    user_data->sentry_info.remote_hp_redeem_count                     = ALL_RX_Data->RX_Data_sentry_info.sentry_info.remote_hp_redeem_count ;
                    user_data->sentry_info.remote_bullet_redeem_count  = ALL_RX_Data->RX_Data_sentry_info.sentry_info.remote_bullet_redeem_count ;
                    user_data->sentry_info.reserved_0                 = ALL_RX_Data->RX_Data_sentry_info.sentry_info.reserved_0 ;
                    user_data->sentry_info.allowed_bullet_redeemed         = ALL_RX_Data->RX_Data_sentry_info.sentry_info.allowed_bullet_redeemed ;
                    user_data->sentry_info.free_revive_available                    = ALL_RX_Data->RX_Data_sentry_info.sentry_info.free_revive_available ;
                    user_data->sentry_info.pay_revive_available                     = ALL_RX_Data->RX_Data_sentry_info.sentry_info.pay_revive_available ;
                    user_data->sentry_info.pay_revive_cost                  = ALL_RX_Data->RX_Data_sentry_info.sentry_info.pay_revive_cost ;
                }
            }break;
